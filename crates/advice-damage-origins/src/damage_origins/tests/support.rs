...
pub fn damage(frame: u32, victim: u8, drop: f32) -> DamageEvent {
    DamageEvent {
        victim,
        start_frame: frame,
...
pub fn contact(frame: u32, projectile: bool) -> ContactEvent {
    ContactEvent {
        frame,
        attacker: 2,
        victim: 1,
...
pub fn features(count: u32) -> Vec<FrameFeatures> {
    (0..count)
...
pub fn advice_card(id: &str, end_frame: Option<u32>) -> AdviceCard {
    AdviceCard {
        id: id.to_string(),
