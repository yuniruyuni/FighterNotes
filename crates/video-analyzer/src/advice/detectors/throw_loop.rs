use crate::advice::{
    AdviceCard, AdviceKind, EvidenceClip, OBSERVATION_REVIEW_CAVEAT, THROW_STREAK_MIN,
};
use crate::match_events::{EventConfidence, MatchEvents, ThrowEvent};

/// 相手の投げが連続で通っているかを検出する。
pub(crate) fn detect_throw_loop(events: &MatchEvents, opponent: u8) -> Option<AdviceCard> {
