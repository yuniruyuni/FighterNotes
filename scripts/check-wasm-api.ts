...
const expectedSpatialMethods = [
  ...
  "observe_inplace(frame_index: number, p1_teleport: boolean, p2_teleport: boolean, p1_airborne: boolean, p2_airborne: boolean, contact: boolean, sides_certain: boolean): void;",
  "reset_window(): void;",
  "rgba_buf_len(): number;",
  "rgba_buf_ptr(): number;",
];
