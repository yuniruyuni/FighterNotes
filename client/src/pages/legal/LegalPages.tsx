  ...
  return (
    ...
    >
      ...
      <section>
        ...
        <p>
          解析後に利用者が「共有URLを生成」を選んだ場合に限り、キャラクター、ラウンド結果、対戦傾向および改善点に加え、両者のSA/CAレベル別使用回数と結果、自分側のSA/CA利用文脈等の集計結果をサーバーへ送信して保存し、公開URLを作成します。SA/CAを完全集計できない場合は、検出できた件数を下限として公開します。
        </p>
        <p>
          動画、動画ファイル名、入力履歴、フレーム番号、自由文、SA/CAの正確なダメージ値および最終ゲージ量は、公開結果に含めません。
        </p>
        <p>
