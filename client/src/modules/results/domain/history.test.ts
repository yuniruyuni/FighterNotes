...
describe("analysis history aggregation", () => {
  ...
  test("全集約fieldを複数レコードから加算する", () => {
    const populated: Partial<TacticStats> = {
      ...
      di_faced: 3,
      di_returned: 4,
      raw_drive_rushes_faced: 5,
      raw_drive_rushes_defended: 6,
      raw_drive_rushes_hit: 7,
      minus_defense_opportunities: 8,
      fastest_strike_challenges: 9,
      fastest_strike_losses: 10,
      fastest_throw_challenges: 11,
      fastest_throw_losses: 12,
      burnout_count: 13,
      burnout_seconds: 14,
      burnout_hp_lost: 15,
      burnout_hp_dealt: 16,
    ...
    expect(summary).toEqual({
      ...
      diReturned: 8,
      rawRushesFaced: 10,
      rawRushesDefended: 12,
      rawRushesHit: 14,
      minusDefenseOpportunities: 16,
      fastestStrikeChallenges: 18,
      fastestStrikeLosses: 20,
      fastestThrowChallenges: 22,
      fastestThrowLosses: 24,
      burnoutCount: 26,
      burnoutSeconds: 28,
      burnoutHpLost: 30,
      burnoutHpDealt: 32,
